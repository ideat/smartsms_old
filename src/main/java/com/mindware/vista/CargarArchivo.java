...
public class CargarArchivo extends Window  {
	...
	public CargarArchivo(int userId) {
		buildMainLayout();
		usuarioId = userId;
	...
	private void InsertarDatos() {
		btnInsertar.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				ConfirmDialog.show(getUI(), "Cofirma la operacion:", "Se dara de baja los contactos y grupos actuales", 
						"Aceptar", "Cancelar", new ConfirmDialog.Listener() {
							
							@Override
							public void onClose(ConfirmDialog dialog) {
								if(dialog.isConfirmed()) {
									contactoService.bajaContactos(usuarioId);
									GrupoService grupoService = new GrupoService();
									grupoService.bajaGrupo(usuarioId);
									
									((smsUI) UI.getCurrent()).actualizarGrupo(); //Actualiza la vista de grupos
									...
									String[] columHeader = tblCSV.getColumnHeaders();
										...
										for (Object itemID : itemIDS) {
											...
											if (ValidarTelefono(d.toString())) {
												...
												contacto.setUsuarioId(usuarioId); //TODO cambiar por el usuario de logeo
