...
//	private ProgressBar progressBar;
	...
	public BandejaSalida(int userId) {
		usuarioId = userId;
		buildMainLayout();
		cabeceraTabla();
...
//			                progressBar.setVisible(true);
	...
	public void datosBandejaSalida() { //TODO : poner parametros para usuario y estado mensaje
		...
		llenarBandejaSalida(mensajeService.findMensajesUsuario(usuarioId,"F")); 
		mensajeService=null;
	...
	private void cabeceraTabla() {
		...
		tblSalida.addContainerProperty("Mensaje", Label.class, null);
		//tblSalida.addContainerProperty("Longitud mensaje", Integer.class, null);
		tblSalida.addContainerProperty("Status", String.class, null);
		tblSalida.addContainerProperty("Detalle Status", Label.class, null);
	...
	private void llenarBandejaSalida(List<Mensaje> mensajes) {
		...
		containerMensaje.addContainerProperty("Mensaje", Label.class,"");
		containerMensaje.addContainerProperty("Status", String.class,"");
		containerMensaje.addContainerProperty("Detalle Status", Label.class,"");
		...
		if (mensajes.size() > 0) {
			...
			for(Mensaje mensaje : mensajes) {
				...
				Label msg = new Label();
				msg.setValue(mensaje.getMensaje());
				msg.setWidth("400px");
				item.getItemProperty("Mensaje").setValue(msg);
				item.getItemProperty("Status").setValue(mensaje.getStatus());
				Label detalle = new Label();
				detalle.setValue(mensaje.getStatusDetalle());
				detalle.setWidth("300px");
				item.getItemProperty("Detalle Status").setValue(detalle);
...
//		mainLayout.addComponent(progressBar);//,"top:100.0px;right:84.0px;bottom:118.0px;left:12.0px;");
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		btnCargarMensajes.setCaption("Actualizar Mensajes");
		btnCargarMensajes.setImmediate(false);
		btnCargarMensajes.setWidth("160px");
		btnCargarMensajes.setHeight("40px");
		btnCargarMensajes.setIcon(new ThemeResource("../images/buttons/order_incoming_24_h.png"));
...
//		horizontalLayout_1.setComponentAlignment(btnreenviar, new Alignment(20));
		...
		btnEliminar.setIcon(new ThemeResource("../images/buttons/delete_24_h.png"));
