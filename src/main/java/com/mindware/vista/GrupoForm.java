...
public class GrupoForm extends CustomComponent {
	...
	public GrupoForm(int userId) {
		...
		btnNuevo.addClickListener(new ClickListener() {
			public void buttonClick(ClickEvent event) {
				AddGrupo addGrupo = new AddGrupo(usuarioId);
	...
	private void componerMensaje() {
		btnComponer.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				componerMensaje.listaGrupoUsuario(usuarioId);
	...
	public void llenarTabla() {
		grupoService = new GrupoService();
		List<Grupo> grupoMiembros = grupoService.getGrupoMiembros(usuarioId); //TODO cambiar el codigo de usuario logeado
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		btnNuevo.setIcon(new ThemeResource("../images/buttons/card-contact.png"));
