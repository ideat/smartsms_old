...
public class AddContacto extends Window implements ClickListener{
	...
	public void buttonClick(ClickEvent event) {
		if(event.getSource()==this.btnguardar){
			if(validarDatos()){
				...
				contacto.setUsuarioId(usuarioId); //TODO reemplazar con el codigo del usuario de logeo
	...
	private HorizontalLayout buildHorizontalLayout_4() {
		...
		btnguardar.setWidth("160px");
		btnguardar.setHeight("40px");
		btnguardar.setIcon(new ThemeResource("../images/buttons/save_24_h.png"));
...
//		});
		...
		btncerrar.setWidth("160px");
		btncerrar.setHeight("40px");
		btncerrar.setIcon(new ThemeResource("../images/buttons/close.png"));
